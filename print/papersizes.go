...
func init() {
	stdPaperSizes.sizes = []PaperSize{
		...
		newPaperSize("iso_b4_250x353mm", "B4 Envelope", 25000, 35300),
		newPaperSize("iso_b5-extra_201x276mm", "B5 Extra", 20100, 27600),
		newPaperSize("iso_b5_176x250mm", "B5 Envelope", 17600, 25000),
		newPaperSize("iso_b6_125x176mm", "B6 Envelope", 12500, 17600),
		...
		newPaperSize("iso_dl_110x220mm", "DL Envelope", 11000, 22000),
		...
		newPaperSize("jpn_chou2_111.1x146mm", "Chou2 Envelope", 11110, 14600),
		newPaperSize("jpn_chou3_120x235mm", "Chou3 Envelope", 12000, 23500),
		newPaperSize("jpn_chou4_90x205mm", "Chou4 Envelope", 9000, 20500),
		newPaperSize("jpn_chou40_90x225mm", "Chou40 Envelope", 9000, 22500),
		newPaperSize("jpn_hagaki_100x148mm", "Hagaki", 10000, 14800),
		newPaperSize("jpn_kahu_240x322.1mm", "Kahu", 24000, 32210),
		newPaperSize("jpn_kaku1_270x382mm", "Kaku1 Envelope", 27000, 38200),
		newPaperSize("jpn_kaku2_240x332mm", "Kaku2 Envelope", 24000, 33200),
		newPaperSize("jpn_kaku3_216x277mm", "Kaku3 Envelope", 21600, 27700),
		newPaperSize("jpn_kaku4_197x267mm", "Kaku4 Envelope", 19700, 26700),
		newPaperSize("jpn_kaku5_190x240mm", "Kaku5 Envelope", 19000, 24000),
		newPaperSize("jpn_kaku7_142x205mm", "Kaku7 Envelope", 14200, 20500),
		newPaperSize("jpn_kaku8_119x197mm", "Kaku8 Envelope", 11900, 19700),
		newPaperSize("jpn_oufuku_148x200mm", "Oufuku", 14800, 20000),
		newPaperSize("jpn_you4_105x235mm", "You4 Envelope", 10500, 23500),
		...
		newPaperSize("na_personal_3.625x6.5in", "Personal Envelope", 3.625*2540, 6.5*2540),
		newPaperSize("na_quarto_8.5x10.83in", "Quarto", 8.5*2540, 10.83*2540),
		newPaperSize("na_super-a_8.94x14in", "Super-A", 8.94*2540, 14*2540),
		...
		newPaperSize("om_invite_220x220mm", "Invite Envelope", 22000, 22000),
		newPaperSize("om_italian_110x230mm", "Italy Envelope", 11000, 23000),
