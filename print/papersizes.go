...
func init() {
	stdPaperSizes.sizes = []PaperSize{
		...
		newPaperSize("iso_c3_324x458mm", "C3", 32400, 45800),
		newPaperSize("iso_c4_229x324mm", "C4", 22900, 32400),
		newPaperSize("iso_c5_162x229mm", "C5", 16200, 22900),
		newPaperSize("iso_c6_114x162mm", "C6", 11400, 16200),
		newPaperSize("iso_c6c5_114x229mm", "C6C5", 11400, 22900),
		newPaperSize("iso_c7_77x114mm", "C7", 7700, 11400),
		newPaperSize("iso_c7c6_81x162mm", "C7C6", 8100, 16200),
		newPaperSize("iso_c8_56x77mm", "C8", 5600, 7700),
		newPaperSize("iso_c9_38x56mm", "C9", 3800, 5600),
		newPaperSize("iso_c10_29x38mm", "C10", 2900, 3800),
		newPaperSize("iso_dl_110x220mm", "DL", 11000, 22000),
		...
		newPaperSize("na_5x7_5x7in", "5x7", 5*2540, 7*2540),
		newPaperSize("na_6x9_6x9in", "6x9", 6*2540, 9*2540),
		newPaperSize("na_7x9_7x9in", "7x9", 7*2540, 9*2540),
		newPaperSize("na_9x11_9x11in", "9x11", 9*2540, 11*2540),
		newPaperSize("na_10x11_10x11in", "10x11", 10*2540, 11*2540),
		newPaperSize("na_10x13_10x13in", "10x13", 10*2540, 13*2540),
		newPaperSize("na_10x14_10x14in", "10x14", 10*2540, 14*2540),
		newPaperSize("na_10x15_10x15in", "10x15", 10*2540, 15*2540),
		newPaperSize("na_11x12_11x12in", "11x12", 11*2540, 12*2540),
		newPaperSize("na_11x15_11x15in", "11x15", 11*2540, 15*2540),
		newPaperSize("na_12x19_12x19in", "12x19", 12*2540, 19*2540),
		...
		newPaperSize("na_c5_6.5x9.5in", "6.5x9.5", 6.5*2540, 9.5*2540),
		newPaperSize("na_c_17x22in", "17x22", 17*2540, 22*2540),
		newPaperSize("na_d_22x34in", "22x34", 22*2540, 34*2540),
		newPaperSize("na_e_34x44in", "34x44", 34*2540, 44*2540),
		newPaperSize("na_edp_11x14in", "11x14", 11*2540, 14*2540),
		newPaperSize("na_eur-edp_12x14in", "12x14", 12*2540, 14*2540),
		newPaperSize("na_executive_7.25x10.5in", "NA Executive", 7.25*2540, 10.5*2540),
		newPaperSize("na_f_44x68in", "44x68", 44*2540, 68*25),
		...
		newPaperSize("na_index-3x5_3x5in", "3.5x5", 3.5*2540, 5*2540),
		newPaperSize("na_index-4x6-ext_6x8in", "6x8", 6*2540, 8*2540),
		newPaperSize("na_index-4x6_4x6in", "4x6", 4*2540, 6*2540),
		newPaperSize("na_index-5x8_5x8in", "5x8", 5*2540, 8*2540),
		newPaperSize("na_invoice_5.5x8.5in", "NA Invoice", 5.5*2540, 8.5*2540),
		newPaperSize("na_ledger_11x17in", "NA Ledger", 11*2540, 17*2540),
		newPaperSize("na_legal-extra_9.5x15in", "9.5x15", 9.5*2540, 15*2540),
		...
		newPaperSize("oe_12x16_12x16in", "12x16", 12*2540, 16*2540),
		newPaperSize("oe_14x17_14x17in", "12x18", 12*2540, 18*2540),
		newPaperSize("oe_18x22_18x22in", "18x22", 18*2540, 22*2540),
		newPaperSize("oe_a2plus_17x24in", "17x24", 17*2540, 24*2540),
		...
		newPaperSize("oe_photo-14x18_14x18in", "Photo 14x18", 14*2540, 18*2540),
		...
		newPaperSize("oe_square-photo_4x4in", "Square Photo 4x4", 4*2540, 4*2540),
		newPaperSize("oe_square-photo_5x5in", "Square Photo 5x5", 5*2540, 5*2540),
		...
		newPaperSize("prc_1_102x165mm", "PRC 1", 10200, 16500),
		newPaperSize("prc_2_102x176mm", "PRC 2", 10200, 17600),
		newPaperSize("prc_4_110x208mm", "PRC 4", 11000, 20800),
		newPaperSize("prc_6_120x320mm", "PRC 6", 12000, 32000),
		newPaperSize("prc_7_160x230mm", "PRC 7", 16000, 23000),
		newPaperSize("prc_8_120x309mm", "PRC 8", 12000, 30900),
